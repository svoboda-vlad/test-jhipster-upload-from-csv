...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, svoboda_vlad.seznam.cz.jhipsterdemo.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, svoboda_vlad.seznam.cz.jhipsterdemo.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, svoboda_vlad.seznam.cz.jhipsterdemo.domain.User.class.getName());
            createCache(cm, svoboda_vlad.seznam.cz.jhipsterdemo.domain.Authority.class.getName());
